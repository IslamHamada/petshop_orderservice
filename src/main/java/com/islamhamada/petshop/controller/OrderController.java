...
public class OrderController {
    ...
    @PostMapping("/{user_id}")
    public ResponseEntity<ElaborateOrderDTO> orderUserCart(@PositiveOrZero @PathVariable long user_id, @Valid @RequestBody OrderCartRequest request){
    ...
    @PreAuthorize("hasAnyRole('Customer')")
    @GetMapping("/{user_id}")
    public ResponseEntity<List<ElaborateOrderDTO>> getOrders(@PositiveOrZero @PathVariable long user_id) {
